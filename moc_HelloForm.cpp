...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HelloForm_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 12)
    ...
    "HelloForm\0checkMethod\0\0nextQuestion\0"
};
...
void HelloForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->checkMethod(); break;
        case 1: _t->nextQuestion(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject HelloForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HelloForm.data,
      qt_meta_data_HelloForm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HelloForm.stringdata))
